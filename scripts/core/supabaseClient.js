...
async function loadSupabaseModule() {
  if (!modulePromise) {
    // Start loading immediately — CDN fetch is the biggest cold-start cost
    modulePromise = import("https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm");
    // Preconnect hint for the CDN to speed up TLS handshake
...
/**
 * Pre-warm: start loading the Supabase CDN module + config immediately.
