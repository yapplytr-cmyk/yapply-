...
/* Back birds – action pose shown when expanded/flipped */
...
export function initDeck() {
  ...
  if (stage) {
    ...
    if (cards.length) {
      ...
      /* Hover: card lifts out, others spread, then flip */
      cards.forEach((card) => {
