        ...
        <div class="nav-bar">
          <a class="brand" href="${content.nav.brandHref || "./index.html"}" aria-label="${content.brand.homeAriaLabel}">
            <span class="brand-mark" aria-hidden="true">
              <svg class="brand-bird marketplace-toggle-bird" viewBox="0 0 120 120" fill="none">
                <g class="marketplace-toggle-bird__character">
                  ...
                  <g class="marketplace-toggle-bird__pen">
                    <rect class="marketplace-toggle-bird__pen-body" x="67" y="73" width="30" height="5" rx="2.5" transform="rotate(-22 67 73)"/>
                    <rect class="marketplace-toggle-bird__pen-cap" x="67" y="73" width="6" height="5" rx="1.2" transform="rotate(-22 67 73)"/>
                    <path class="marketplace-toggle-bird__pen-tip" d="M97 61 104 58 101 66Z"/>
                  </g>
                </g>
              </svg>
            </span>
