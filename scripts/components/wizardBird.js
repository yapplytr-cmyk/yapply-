/* ─────────────────────────────────────────────────
   ...
   Matches the Explore page toggle bird style:
   warm golden body, dark wing, small dark eye,
   golden beak, simple geometric shapes.
   All poses use identical viewBox & bird size.
   ───────────────────────────────────────────────── */
...
// ── Unified viewBox for ALL poses: "0 0 100 80" ──
// Bird body is always the same size and position.
// Props are placed around it.
const VB = "0 0 100 80";
