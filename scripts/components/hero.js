      ...
      <div class="hero-grid">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            <a class="button button--primary hero-cta" href="${content.hero.primaryCta.href}">
              <svg class="hero-cta__icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M2 10h20v11a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V10Z"/>
            ...
            ${content.hero.secondaryCta ? createButton({ href: content.hero.secondaryCta.href, label: content.hero.secondaryCta.label, variant: "secondary" }) : ""}
          </div>
