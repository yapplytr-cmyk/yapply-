/**
 * Post-signup Onboarding Tutorial — 3-slide overlay explaining how the marketplace works.
 * Shown once after account creation, then never again.
 */

const ICON_STROKE = "currentColor";

/* Slide 1 icon: camera + form (Create Listing) */
...
/* Slide 2 icon: bid cards / marketplace connection */
...
/* Slide 3 icon: profile + star + checkmark (Choose & Complete) */
...
/**
 * Show the 3-slide onboarding tutorial as a fullscreen overlay.
